...
from arouse._dj.core.management.base import (
    BaseCommand, CommandError, CommandParser, handle_default_options,
)
from arouse._dj.core.management.color import color_style
from arouse._dj.utils import autoreload, lru_cache, six
    ...
    def execute(self):
        ...
        if settings.configured:
            ...
            if subcommand == 'runserver' and '--noreload' not in self.argv:
                try:
                    autoreload.check_errors(_dj.setup)()
                except Exception:
        ...
        # 'django-admin --help' to work, for backwards compatibility.
            ...
            sys.stdout.write(_dj.get_version() + '\n')
