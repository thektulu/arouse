...
from arouse import _dj
from arouse._dj.core import checks
from arouse._dj.core.exceptions import ImproperlyConfigured
from arouse._dj.core.management.color import color_style, no_style
from arouse._dj.db import DEFAULT_DB_ALIAS, connections
from arouse._dj.db.migrations.exceptions import MigrationSchemaMissing
...
class BaseCommand(object):
    ...
    def execute(self, *args, **options):
        ...
        if not self.leave_locale_alone:
            ...
            # translations.
            from arouse._dj.utils import translation
