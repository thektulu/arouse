...
from arouse._dj.db.transaction import atomic
from arouse._dj.utils.encoding import python_2_unicode_compatible
...
class Migration(object):
    ...
    Migration files will import this from arouse._dj.db.migrations.Migration
    and subclass it as a class called Migration. It will have one or more
    of the following attributes:

     - operations: A list of Operation instances, probably from arouse._dj.db.migrations.operations
