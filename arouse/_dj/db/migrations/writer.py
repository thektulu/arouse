...
from arouse._dj import get_version
from arouse._dj.apps import apps
from arouse._dj.db import migrations
from arouse._dj.db.migrations.loader import MigrationLoader
from arouse._dj.db.migrations.serializer import serializer_factory
from arouse._dj.utils._os import upath
from arouse._dj.utils.encoding import force_text
from arouse._dj.utils.inspect import get_func_args
from arouse._dj.utils.module_loading import module_dir
from arouse._dj.utils.timezone import now
    ...
    def as_string(self):
        ...
        for dependency in self.migration.dependencies:
            if dependency[0] == "__setting__":
                ...
                imports.add("from arouse._dj.conf import settings")
            else:
        ...
        if "from arouse._dj.db import models" in imports:
            imports.discard("from arouse._dj.db import models")
            imports.add("from arouse._dj.db import migrations, models")
        else:
            imports.add("from arouse._dj.db import migrations")
