...
from arouse._dj.db.models.expressions import Func, Star
from arouse._dj.db.models.fields import DecimalField, FloatField, IntegerField
...
class Avg(Aggregate):
    ...
    def as_oracle(self, compiler, connection):
        if self.output_field.get_internal_type() == 'DurationField':
            ...
            from arouse._dj.db.backends.oracle.functions import IntervalToSeconds, SecondsToInterval
