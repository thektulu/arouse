...
from arouse._dj.core import checks, exceptions, validators
# When the _meta object was formalized, this exception was moved to
# django.core.exceptions. It is retained here for backwards compatibility
# purposes.
from arouse._dj.core.exceptions import FieldDoesNotExist  # NOQA
from arouse._dj.db import connection, connections, router
from arouse._dj.db.models.query_utils import DeferredAttribute, RegisterLookupMixin
from arouse._dj.utils import six, timezone
from arouse._dj.utils.datastructures import DictWrapper
from arouse._dj.utils.dateparse import (
    parse_date, parse_datetime, parse_duration, parse_time,
)
from arouse._dj.utils.deprecation import (
    RemovedInDjango20Warning, warn_about_renamed_method,
)
from arouse._dj.utils.duration import duration_string
from arouse._dj.utils.encoding import (
    force_bytes, force_text, python_2_unicode_compatible, smart_text,
)
from arouse._dj.utils.functional import Promise, cached_property, curry
from arouse._dj.utils.ipv6 import clean_ipv6_address
from arouse._dj.utils.itercompat import is_iterable
from arouse._dj.utils.text import capfirst
...
class Field(RegisterLookupMixin):
    ...
    def get_col(self, alias, output_field=None):
        ...
        if alias != self.model._meta.db_table or output_field != self:
            from arouse._dj.db.models.expressions import Col
    ...
    def deconstruct(self):
        ...
        path = "%s.%s" % (self.__class__.__module__, self.__class__.__name__)
        if path.startswith("arouse._dj.db.models.fields.related"):
            path = path.replace("arouse._dj.db.models.fields.related", "arouse._dj.db.models")
        if path.startswith("arouse._dj.db.models.fields.files"):
            path = path.replace("arouse._dj.db.models.fields.files", "arouse._dj.db.models")
        if path.startswith("arouse._dj.db.models.fields.proxy"):
            path = path.replace("arouse._dj.db.models.fields.proxy", "arouse._dj.db.models")
        if path.startswith("arouse._dj.db.models.fields"):
            path = path.replace("arouse._dj.db.models.fields", "arouse._dj.db.models")
