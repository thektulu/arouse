from arouse._dj.db.models.lookups import (
...
class RelatedIn(In):
    ...
    def as_sql(self, compiler, connection):
        if isinstance(self.lhs, MultiColSource):
            ...
            from arouse._dj.db.models.sql.where import WhereNode, SubqueryConstraint, AND, OR
...
class RelatedLookupMixin(object):
    ...
    def as_sql(self, compiler, connection):
        if isinstance(self.lhs, MultiColSource):
            ...
            from arouse._dj.db.models.sql.where import WhereNode, AND
