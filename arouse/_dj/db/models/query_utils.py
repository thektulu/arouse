...
Factored out from arouse._dj.db.models.query to avoid making the main module very
...
from arouse._dj.utils import tree
...
class RegisterLookupMixin(object):
    ...
    def get_lookup(self, lookup_name):
        from arouse._dj.db.models.lookups import Lookup
    ...
    def get_transform(self, lookup_name):
        from arouse._dj.db.models.lookups import Transform
        found = self._get_lookup(lookup_name)
        if found is None and hasattr(self, 'output_field'):
