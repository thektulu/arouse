...
from arouse._dj.core.exceptions import FieldDoesNotExist, FieldError
from arouse._dj.db import DEFAULT_DB_ALIAS, connections
from arouse._dj.db.models.aggregates import Count
from arouse._dj.db.models.constants import LOOKUP_SEP
from arouse._dj.db.models.expressions import Col, Ref
from arouse._dj.db.models.fields.related_lookups import MultiColSource
from arouse._dj.db.models.query_utils import (
    PathInfo, Q, check_rel_lookup_compatibility, refs_expression,
)
from arouse._dj.db.models.sql.constants import (
    INNER, LOUTER, ORDER_DIR, ORDER_PATTERN, QUERY_TERMS, SINGLE,
)
from arouse._dj.db.models.sql.datastructures import (
    BaseTable, Empty, EmptyResultSet, Join, MultiJoin,
)
from arouse._dj.db.models.sql.where import (
...
from arouse._dj.utils.tree import Node
...
class Query(object):
    ...
    def get_aggregation(self, using, added_aggregate_names):
        ...
        if (isinstance(self.group_by, list) or has_limit or has_existing_annotations or
                self.distinct):
            from arouse._dj.db.models.sql.subqueries import AggregateQuery
