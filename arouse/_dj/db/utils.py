...
from arouse._dj.utils._os import npath, upath
...
def load_backend(backend_name):
    ...
    try:
        ...
        try:
            ...
            builtin_backends = []
        if backend_name not in ['arouse._dj.db.backends.%s' % b for b in
                                builtin_backends]:
...
class ConnectionHandler(object):
    ...
    def databases(self):
        ...
        if self._databases[DEFAULT_DB_ALIAS] == {}:
            self._databases[DEFAULT_DB_ALIAS]['ENGINE'] = 'arouse._dj.db.backends.dummy'
    ...
    def ensure_defaults(self, alias):
        ...
        conn.setdefault('ENGINE', 'arouse._dj.db.backends.dummy')
        if conn['ENGINE'] == 'arouse._dj.db.backends.' or not conn['ENGINE']:
            conn['ENGINE'] = 'arouse._dj.db.backends.dummy'
